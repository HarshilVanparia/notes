...
**A sleek, dark-themed rich notepad with built-in drawing canvas and image gallery.**
...
- 4 stroke thickness levels
- Undo & Clear actions
- Strokes saved with notes (not pasted as images!)
...
- Grid layout gallery panel
- Multi-image upload support
- Easy remove / reposition
...
| HTML5 / CSS3 | UI rendering & styling |
...
<tr><td rowspan="5"><b>Edit</b></td><td>Undo</td><td><kbd>Ctrl</kbd>+<kbd>Z</kbd></td></tr>
...
<tr><td rowspan="2"><b>Draw Canvas</b></td><td>Pen Tool</td><td><kbd>P</kbd></td></tr>
...
└── app/
    ...
    ├── renderer.js        # Frontend logic (editor, tabs, draw, gallery)
...
3. **Renderer** (`renderer.js`) manages the rich text editor, tab system, draw canvas, image gallery, and all UI interactions
4. Session data (open tabs, content) is saved to `userData/session.json` and restored on relaunch
